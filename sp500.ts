export const SP500_COMPANIES = [
  ...
  { symbol: "APO", name: "Apogee Enterprises" },
  ...
  { symbol: "TECH", name: "Best Buy" },
  { symbol: "BIIB", name: "Biogen" },
  { symbol: "BLK", name: "BlackRock" },
  { symbol: "BX", name: "Berkshire Hathaway" },
  ...
  { symbol: "BR", name: "Banco Santander" },
  { symbol: "BRO", name: "Brown & Brown" },
  { symbol: "BF.B", name: "Brown & Brown" },
  { symbol: "BLDR", name: "Blonder Tongue Laboratories" },
  ...
  { symbol: "CDW", name: "CDW" },
  { symbol: "COR", name: "Campbell Soup" },
  { symbol: "CNC", name: "Centene" },
  { symbol: "CNP", name: "Cenovus Energy" },
  ...
  { symbol: "CB", name: "City of Hope" },
  { symbol: "CHD", name: "Chatham Lodging Trust" },
  ...
  { symbol: "DAY", name: "Dollar General" },
  { symbol: "DECK", name: "Deckers Outdoor" },
  { symbol: "DE", name: "DuPont" },
  ...
  { symbol: "DPZ", name: "Dominion Energy" },
  ...
  { symbol: "ERIE", name: "Erie Insurance Group" },
  { symbol: "ESS", name: "ESS Energy Services" },
  { symbol: "EL", name: "Estée Lauder" },
  { symbol: "EG", name: "Enel Green Power" },
  { symbol: "EVRG", name: "Evergy" },
  { symbol: "ES", name: "Eversource Energy" },
  { symbol: "EXC", name: "Exelon" },
  { symbol: "EXE", name: "Expedia Group" },
  ...
  { symbol: "FI", name: "Fidelity National Information Services" },
  { symbol: "F", name: "Ford" },
  ...
  { symbol: "GEHC", name: "General Electric" },
  { symbol: "GEV", name: "General Electric" },
  { symbol: "GEN", name: "Genpact" },
  ...
  { symbol: "HWM", name: "Hawaiian Electric Industries" },
  { symbol: "HPQ", name: "HP" },
  ...
  { symbol: "PARA", name: "Pan American Silver" },
  { symbol: "PH", name: "Phillips 66" },
  ...
  { symbol: "PWR", name: "Quaker Chemical" },
  ...
  { symbol: "O", name: "O'Reilly Automotive" },
  ...
  { symbol: "SW", name: "Stanley Black & Decker" },
  { symbol: "SNA", name: "SNA" },
  { symbol: "SOLV", name: "Solvay" },
  { symbol: "SO", name: "Southern Company" },
  { symbol: "LUV", name: "Southwest Airlines" },
  { symbol: "SWK", name: "Southwest Airlines" },
  { symbol: "SBUX", name: "Starbucks" },
  { symbol: "STT", name: "State Street" },
  { symbol: "STLD", name: "Stardard" },
  { symbol: "STE", name: "STERIS" },
  { symbol: "SYK", name: "Stryker" },
  { symbol: "SMCI", name: "Semiconductor Manufacturing International" },
  ...
  { symbol: "TEL", name: "Teladoc Health" },
  { symbol: "TDY", name: "Teradyne" },
  { symbol: "TER", name: "Terreno" },
  { symbol: "TSLA", name: "Tesla" },
  { symbol: "TXN", name: "Texas Instruments" },
  { symbol: "TPL", name: "Texas Instruments" },
  { symbol: "TXT", name: "Textron" },
  { symbol: "TMO", name: "Thermo Fisher Scientific" },
  { symbol: "TJX", name: "TJX" },
  { symbol: "TKO", name: "The Kraft Heinz Company" },
  { symbol: "TSCO", name: "Tractor Supply" },
  { symbol: "TT", name: "Tetra Technologies" },
  { symbol: "TDG", name: "TDG" },
  { symbol: "TRV", name: "Travelers" },
  { symbol: "TRMB", name: "Trustmark" },
  { symbol: "TFC", name: "Truist Financial" },
  { symbol: "TYL", name: "Tilly's" },
  ...
  { symbol: "WM", name: "Williams Companies" },
  { symbol: "WAT", name: "Watts Water Technologies" },
  { symbol: "WEC", name: "WEC Energy Group" },
  { symbol: "WFC", name: "Wells Fargo" },
  { symbol: "WELL", name: "Welltower" },
  { symbol: "WST", name: "Westinghouse Air Brake Technologies" },
  { symbol: "WDC", name: "Western Digital" },
  { symbol: "WY", name: "Weyerhaeuser" },
  { symbol: "WSM", name: "Westinghouse Air Brake Technologies" },
...
// export const SP500_SYMBOLS = [...]; // (commented out if present) 